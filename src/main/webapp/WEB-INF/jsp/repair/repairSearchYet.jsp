...
//            一个页面固定10条数据
        ...
        function queryAllPerson(pageNum, pageSize) {
            $("#edit_area_div").load("${pageContext.request.contextPath}/worker/queryDealRepairRecord.action?pageNum=" + pageNum + "&pageSize=" + pageSize);
        }
    </script>
</head>
<body>
<div  id="edit_area_div">
    <div class="search">
        <p class="sear">报修查询-已处理</p>
        <div class="fun">
                <form class="bs-example bs-example-form" role="form"
                      action="${pageContext.request.contextPath}/worker/findDealRepairRecoreByStudentId.action"
                      method="post">
                ...
                <div class="chargeList">
                    <table class="table table-bordered" id="responseText">
                        ...
                        <c:forEach var="repairRecordCustomStrList" items="${repairRecordCustomStrList}">
                            <tr onload="load()">
                                <td>
                                    <a href="${pageContext.request.contextPath}/worker/findRepairRecordByStudentIdAndrepairContentYet.action?studentId=${repairRecordCustomStrList.studentId}&repairContent=${repairRecordCustomStrList.repairContent}">${repairRecordCustomStrList.name}</a>
                                </td>
                                ...
                                <td>
                                    <button class="btn btn-defaultv aaa"type="button" value="${repairRecordCustomStrList.resultFlag}" onclick="window.location.href='${pageContext.request.contextPath}/worker/findRepairRecordByStudentIdAndrepairContentYet.action?studentId=${repairRecordCustomStrList.studentId}&repairContent=${repairRecordCustomStrList.repairContent}'">
                                        处理
                                    </button>
                                </td>
                            </tr>
