...
//    }
    ...
    public ExcelInUtil(String excelPath){
     ...
     * @return
     */
    public ExcelInUtil RestoreSettings(){
        ExcelInUtil instance = new ExcelInUtil(this.excelPath);
        return instance;
    }
        ...
        try {
            ...
            if (file.exists()) {
                ...
                if (isOverWrite) {
                    ...
                    FileInputStream fis = new FileInputStream(src_xlsPath);
